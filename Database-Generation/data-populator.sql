...
VALUES ('The Great Delhi Warehouse', '987-345-678', '102', 'Central Delhi', 'Delhi', 'Delhi', 110001, 'India'),
       ('The Classic Mumbai Warehouse', '987-123-456', '267', 'South Mumbai', 'Mumbai', 'Maharashtra', 400001, 'India'),
       ('Bangalore Storage', '987-987-654', '394', 'Koramangala', 'Bangalore', 'Karnataka', 560001, 'India'),
       ('Chennai Depot', '987-234-567', '507', 'T. Nagar', 'Chennai', 'Tamil Nadu', 600001, 'India'),
       ('Kolkata Distribution Center', '987-789-654', '623', 'Salt Lake City', 'Kolkata', 'West Bengal', 700001, 'India'),
       ('Hyderabad Supply Hub', '987-456-789', '735', 'Gachibowli', 'Hyderabad', 'Telangana', 500001, 'India'),
       ('Pune Logistics', '987-234-567', '852', 'Koregaon Park', 'Pune', 'Maharashtra', 411001, 'India'),
       ('Ahmedabad Warehouse', '987-789-654', '924', 'Vastrapur', 'Ahmedabad', 'Gujarat', 380001, 'India'),
       ('Surat Distribution Center', '987-123-456', '103', 'Adajan', 'Surat', 'Gujarat', 395001, 'India'),
       ('Jaipur Storage', '987-987-654', '287', 'Malviya Nagar', 'Jaipur', 'Rajasthan', 302001, 'India'),
       ('Lucknow Warehouse', '987-345-678', '394', 'Gomti Nagar', 'Lucknow', 'Uttar Pradesh', 226001, 'India'),
       ('Kanpur Depot', '987-123-456', '407', 'Civil Lines', 'Kanpur', 'Uttar Pradesh', 208001, 'India'),
       ('Nagpur Storage', '987-987-654', '523', 'Dharampeth', 'Nagpur', 'Maharashtra', 440001, 'India'),
       ('Indore Distribution Center', '987-234-567', '635', 'Vijay Nagar', 'Indore', 'Madhya Pradesh', 452001, 'India'),
       ('Thane Warehouse', '987-789-654', '752', 'Thane West', 'Thane', 'Maharashtra', 400601, 'India'),
       ('Bhopal Depot', '987-456-789', '824', 'Arera Colony', 'Bhopal', 'Madhya Pradesh', 462001, 'India'),
       ('Visakhapatnam Warehouse', '987-234-567', '903', 'Dwaraka Nagar', 'Visakhapatnam', 'Andhra Pradesh', 530001, 'India'),
       ('Patna Storage', '987-789-654', '127', 'Kankarbagh', 'Patna', 'Bihar', 800001, 'India'),
       ('Ludhiana Warehouse', '987-123-456', '203', 'Model Town', 'Ludhiana', 'Punjab', 141001, 'India'),
       ('Agra Workshop', '987-987-654', '367', 'Sadar Bazaar', 'Agra', 'Uttar Pradesh', 282001, 'India');
